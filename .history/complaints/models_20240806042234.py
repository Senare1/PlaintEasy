...
class Response(models.Model):
    complainant = models.ForeignKey(CommonUser,on_delete=models.CASCADE,related_name='responses')
    complaint = models.ForeignKey(Complaint,on_delete=models.CASCADE,related_name='complaints',blank=True,null=True)
