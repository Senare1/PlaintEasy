...
class Proof(models.Model):
    image = models.FileField(upload_to="complaints/proof/images",validators=[validate_image],blank=True,null=True)
    video = models.FileField(upload_to="complaints/proof/videos",validators=[validate_video],blank=True,null=True)
    audio = models.FileField(upload_to="complaints/proof/audios",validators=[validate_audio],blank=True,null=True)
    document = models.FileField(upload_to="complaints/proof/documents",validators=[validate_document],blank=True,null=True)
    proof_complaint = models.ForeignKey(Complaint,on_delete=models.CASCADE)
