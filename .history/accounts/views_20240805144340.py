...
def complaint_detail(request, id):
    ...
    images = [proof for proof in proofs if proof.image]
    print(complaint.motif)
    for image in images:
        print(image)
    videos = [proof for proof in proofs if proof.video]
    for video in videos:
        print(video)
    audios = [proof for proof in proofs if proof.audio]
    for audio in audios:
        print(audio)
    documents = [proof for proof in proofs if proof.document]
