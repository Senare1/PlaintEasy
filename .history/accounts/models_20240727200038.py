...
class CommonUser(AbstractBaseUser,PermissionsMixin):
    ...
    customer_register = models.CharField(max_length=8,blank=True,null=True)
    enterprise_name = models.CharField(max_length=128,blank=True,null=True)
    employee_role = models.CharField(max_length=8,choices=ROLES,blank=True,null=True)
